...
var db = [{
  ...
  actors: ["Ben Affleck", "Henry Cavill", "Amy Adams", "Gal Gadot", "Ray Fisher", "Jason Momoa", "Ezra Miller", "Willem Dafoe", "Jesse Eisenberg", "Jeremy Irons", "Diane Lane", "Connie Nielsen", "J. K. Simmons"]
}, {
  id: 261,
  name: "A Talking Cat!?!",
  guests: ["Jessica St. Clair"],
  directors: ["David DeCoteau"],
  actors: ["Johnny Whitaker", "Kristine DeBell", "Justin Cone", "Janis Peebles", "Alison Sieke", "Daniel Dannas", "Eric Roberts"]
}, {
  id: 260,
  name: "Jade",
  guests: [],
  directors: ["William Friedkin"],
  actors: ["David Caruso", "Linda Fiorentino", "Chazz Palminteri", "Michael Biehn", "Richard Crenna"]
}, {
  id: 259,
  ...
  actors: ["Patricia Arquette", "Joseph Gordon-Levitt", "Tate Donovan", "Armin Mueller-Stahl"]
}, {
  id: 257,
  name: "Lawnmower Man 2: Beyond Cyberspace",
  guests: [],
  directors: ["Farhad Mann"],
  actors: ["Patrick Bergin", "Matt Frewer", "Austin O'Brien", "Ely Pouget", "Camille Cooper", "Kevin Conway"]
}, {
  id: 256,
  name: "A Gnome Named Gnorm",
  guests: [],
  directors: ["Stan Winston"],
  actors: ["Anthony Michael Hall", "Jerry Orbach", "Claudia Christian", "Eli Danker", "Mark Harelik", "Robert Z'Dar", "Pat Crawford Brown", "Joseph R. Sicari", "Greg Kean"]
}, {
  id: 255,
  name: "A Very Nutty Christmas ",
  guests: ["Jessica St. Clair"],
  directors: ["Colin Theys"],
  actors: ["Melissa Joan Hart", "Barry Watson", "Marissa Jaret Winokur "]
}, {
  id: 254,
  name: "Love's Labour's Lost",
  guests: [],
  directors: ["Kenneth Branagh"],
  actors: ["Kenneth Branagh", "Nathan Lane", "Adrian Lester", "Matthew Lillard", "Natascha McElhone", "Alessandro Nivola", "Alicia Silverstone", "Timothy Spall"]
}, {
  id: 205,
  name: "Cellular",
